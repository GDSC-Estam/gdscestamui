      ...
      <div className="w-full h-screen bg">
        <div className="w-full h-screen flex flex-col items-center py-8">
          <div className="flex-1 flex flex-col items-center justify-center">
            <h1 className="text-4xl lg:text-8xl text-gray-200 tracking-wider font-bold font-serif mt-12 text-center">Nothing Yet!</h1>
            <div className="flex flex-col items-center space-y-4 mt-24">
              <p className="text-gray-300 uppercase text-sm">Notify me when you upload your past events</p>
